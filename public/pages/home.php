<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Сайт поиска фильмов и прогноза погоды</h1>

    <?php
    if ($_COOKIE) {
    ?>
        <p class="lead">Приветствую тебя, <?php echo $_COOKIE['userName']; ?>!</p>
    <?php
    } else {
    ?>
        <p class="lead">Для использования всех возможностей сайта необходима регистрация</p>
    <?php
    }
    ?>
</div>
        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-outline-primary">Подпишитесь
                        бесплатно</button>
                </div>
            </div>
        </div>
